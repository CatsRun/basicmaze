...
# lLists for player, keys, walls
    ...
    def setup(self):
        ...
        self.key_list_list = arcade.SpriteList()

        # Score
        self.score = 0

        # Set up the player
        self.player_sprite = arcade.Sprite("ladybug.png", SPRITE_SCALING_PLAYER)

        # ****************************
        # *** What does this mean: = 50? ***
        # *****************************
    ...
    def on_updated(self, delta_time):
        self.player_list.on_updated()
